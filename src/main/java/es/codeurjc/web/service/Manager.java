...
/**
 * Service class responsible for initializing default data in the application.
 * <p>
 * The {@code Manager} class is annotated with {@link org.springframework.stereotype.Service}
 * and is used to populate the database with default users, posts, and sections upon application startup.
 * It uses the {@link javax.annotation.PostConstruct} annotation to execute the initialization logic
 ...
 * <ul>
 *   <li>Creating default users with encoded passwords and profile images.</li>
 *   <li>Creating default posts with associated images and assigning them to users.</li>
 *   <li>Creating default sections with images and average ratings.</li>
 *   <li>Establishing relationships such as user follows, section follows, and post contributors.</li>
 * </ul>
 * </p>
 *
 * <p>
 * The class also provides a utility method {@code localImageToBlob} to convert local image files
 * into {@link java.sql.Blob} objects for storage in the database.
 * </p>
 *
 * <p>
 * Dependencies are injected for user, post, and section services, as well as a password encoder.
 * </p>
 *
 * @author Grupo 1
 */
...
public class Manager {
        ...
        public void init() {
                try {
                        ...
                        Post post2 = new Post(
                                        "Explotación de Vulnerabilidades en Aplicaciones Web y Sistemas Embebidos",
                        ...
                        Section defaultSection5 = new Section("WiFi",
                                        "Ataques y auditorías de seguridad en redes inalámbricas.");
        ...
        public Blob localImageToBlob(String localFilePath) {
                ...
                if (imageFile.exists()) {
                        try {
                                return BlobProxy.generateProxy(imageFile.toURI().toURL().openStream(),
                                                imageFile.length());

                        } catch (IOException e) {
                                throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
                                                "Error at processing the image");
                        }
                }
                return null;
        }
