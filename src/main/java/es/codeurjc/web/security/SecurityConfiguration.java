...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain apiFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .requestMatchers(HttpMethod.GET, "/api/post/*")
                .hasAnyRole("USER", "ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/post/*/image")
                .hasAnyRole("USER", "ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/post/comments")
                .hasAnyRole("USER", "ADMIN")
                ...
                .requestMatchers(HttpMethod.POST, "/api/post/*/comments")
                .hasRole("USER")
                .requestMatchers(HttpMethod.PUT, "/api/post/*").hasRole("USER")
                .requestMatchers(HttpMethod.PUT, "/api/post/*/image").hasRole("USER")
                .requestMatchers(HttpMethod.PUT, "/api/post/*/comments/*")
                .hasRole("USER")
                .requestMatchers(HttpMethod.DELETE, "/api/post/*").hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/post/*/image")
                .hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/post/*/comments/*")
                .hasRole("ADMIN")
                // PUBLIC ENDPOINTS
